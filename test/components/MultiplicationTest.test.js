...
describe('MultiplicationTest Component', () => {
  test('devrait afficher correctement les nombres à multiplier', async () => {
    const item = {
      id: '1',
      firstNumber: 6,
      secondNumber: 7,
    ...
    const componentPath = 'src/components/tests/MultiplicationTest.astro';
